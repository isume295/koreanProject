...
export const CacheBalanceTableData = [
  {
    ...
    RepresentativeName: (
      <Link
        href={"/admin/Payment-management/cache-management/Particular"}
...
export const CacheWithDrawalATableData = Array.from({ length: 10 }, () => ({
  Checkbox: <NCheckBox size="md" />,
  timeAndDate: (
    <div className="flex flex-col justify-center items-center gap-1">
      <span>2023-01-08</span>
      <span>00:00</span>
