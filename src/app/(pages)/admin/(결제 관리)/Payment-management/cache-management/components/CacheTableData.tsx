...
export const CacheBalanceTableData = [
  {
   ...
   RepresentativeName: <Link href={"/admin/Payment-management/cache-management/Particular"} className="text-sm text-[#429FFF] underline">홍길동</Link>,
   contact: "01011112222",
    AccountStatus:"정상",
     BalanceCash:"20,000"
...
export const CacheWithDrawalHeader = [
  { label: <Checkbox Label={false} options={['']} selectedValues={['']} onChange={()=>{}}/> ,},
  { label: "신청일시" },
  { label: "상태" },
  { label: "구분" },
  { label: "사업자명" },
...
export const CacheWithDrawalATableData = [
  {
   Checkbox: <Checkbox Label={false} options={['']} selectedValues={['']} onChange={()=>{}}/>,
    timeAndDate: (
      <div className="flex flex-col justify-center items-center gap-1">
        <span>2023-01-08</span>
        <span>00:00</span>
